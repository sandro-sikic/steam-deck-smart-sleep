...
export default function App() {
  ...
  const command = 'curl -L https://raw.githubusercontent.com/username/steamdeck-fix/main/install.sh | sh';
      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4 py-20">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-xl md:text-2xl text-slate-300 mb-6">
            Automatically shutdown your Steam Deck during sleep to eliminate battery drain
          </p>
          
          <div className="text-left max-w-2xl mx-auto space-y-4 text-slate-300">
            <p>
              Your Steam Deck drains approximately <strong className="text-white">1% battery per hour</strong> in sleep mode. This fix automatically shuts down your device after a configurable delay when it enters sleep, preventing unintentional battery drain during transport.
            </p>
            ...
            <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-4 space-y-2">
              ...
              <ul className="space-y-2 text-sm text-slate-300 ml-7">
                <li>• Sets an RTC alarm when your Steam Deck enters sleep mode</li>
                <li>• After your configured timeout, the device wakes briefly</li>
                <li>• Automatically performs a clean shutdown to preserve battery</li>
                <li>• If you wake the device manually before the timer, the shutdown is canceled</li>
              </ul>
            </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-200/90">
                    Always save your game progress before putting your Steam Deck to sleep. All in-memory data will be lost when the device shuts down.
                  </p>
                </div>
              </div>
            </div>
